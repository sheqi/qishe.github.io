...
<i class="fa-li fa fa-file-text-o pub-icon" aria-hidden="true"></i>
    <span itemprop="name">
        <a href="https://www.nature.com/articles/srep21468"><i>PDO-s3DCNNs: Partial Differential Operator Based Steerable 3D CNNs
</i></a>
    </span>
    <div class="pub-authors" itemprop="author">
...
<i class="fa-li fa fa-file-text-o pub-icon" aria-hidden="true"></i>
    <span itemprop="name">
        <a href="https://www.nature.com/articles/srep21468"><i>Weakly Supervised Object Localization as Domain Adaption
</i></a>
    </span>
    <div class="pub-authors" itemprop="author">
...
<i class="fa-li fa fa-file-text-o pub-icon" aria-hidden="true"></i>
    <span itemprop="name">
        <a href="https://www.nature.com/articles/srep21468"><i>On Learning Contrastive Representations for Learning with Noisy Labels
</i></a>
    </span>
    <div class="pub-authors" itemprop="author">
...
<i class="fa-li fa fa-file-text-o pub-icon" aria-hidden="true"></i>
    <span itemprop="name">
        <a href="https://www.nature.com/articles/srep21468"><i>Learning from Temporal Gradient for Semi-supervised Action Recognition
</i></a>
    </span>
    <div class="pub-authors" itemprop="author">
...
<i class="fa-li fa fa-file-text-o pub-icon" aria-hidden="true"></i>
    <span itemprop="name">
        <a href="https://www.nature.com/articles/srep21468"><i>Unifying Nonlocal Blocks for Neural Networks</i></a>
    </span>
    <div class="pub-authors" itemprop="author">
...
<i class="fa-li fa fa-file-text-o pub-icon" aria-hidden="true"></i>
    <span itemprop="name">
        <a href="https://www.nature.com/articles/srep21468"><i>MT-ORL: Multi-Task Occlusion Relationship Learning</i></a>
    </span>
    <div class="pub-authors" itemprop="author">
...
<i class="fa-li fa fa-file-text-o pub-icon" aria-hidden="true"></i>
    <span itemprop="name">
        <a href="https://www.nature.com/articles/srep21468"><i>MINE: Towards Continuous Depth MPI with NeRF for Novel View Synthesis</i></a>
    </span>
    <div class="pub-authors" itemprop="author">
...
<i class="fa-li fa fa-file-text-o pub-icon" aria-hidden="true"></i>
    <span itemprop="name">
        <a href="https://www.nature.com/articles/srep21468"><i>Involution: Inverting the Inherence of Convolution for Visual Recognition</i></a>
    </span>
    <div class="pub-authors" itemprop="author">
...
<i class="fa-li fa fa-file-text-o pub-icon" aria-hidden="true"></i>
    <span itemprop="name">
        <a href="https://www.nature.com/articles/srep21468"><i>ACTION-Net: Multipath Excitation for Action Recognition</i></a>
    </span>
    <div class="pub-authors" itemprop="author">
...
<i class="fa-li fa fa-file-text-o pub-icon" aria-hidden="true"></i>
    <span itemprop="name">
        <a href="https://www.nature.com/articles/srep21468"><i>Learning the Superpixel in a Non-iterative and Lifelong Manner</i></a>
    </span>
    <div class="pub-authors" itemprop="author">
...
<i class="fa-li fa fa-file-text-o pub-icon" aria-hidden="true"></i>
    <span itemprop="name">
        <a href="https://www.nature.com/articles/srep21468"><i>OpenLORIS-Object: A Robotic Vision Dataset and Benchmark for Lifelong Deep Learning</i></a>
    </span>
    <div class="pub-authors" itemprop="author">
...
<i class="fa-li fa fa-file-text-o pub-icon" aria-hidden="true"></i>
    <span itemprop="name">
        <a href="https://www.nature.com/articles/srep21468"><i>Are We Ready for Service Robots? The OpenLORIS-Scene Datasets for Lifelong SLAM</i></a>
    </span>
    <div class="pub-authors" itemprop="author">
...
<i class="fa-li fa fa-file-text-o pub-icon" aria-hidden="true"></i>
    <span itemprop="name">
        <a href="https://www.nature.com/articles/srep21468"><i>Neural Dynamics Discovery via Gaussian Process Recurrent Neural Networks</i></a>
    </span>
    <div class="pub-authors" itemprop="author">
        <b> Qi She </b>, Anqi Wu.
    </div>
...
<i class="fa-li fa fa-file-text-o pub-icon" aria-hidden="true"></i>
    <span itemprop="name">
        <a href="https://www.nature.com/articles/srep21468"><i>Reduced-Rank Linear Dynamical Systems</i></a>
    </span>
    <div class="pub-authors" itemprop="author">
...
<i class="fa-li fa fa-file-text-o pub-icon" aria-hidden="true"></i>
    <span itemprop="name">
        <a href="https://www.nature.com/articles/srep21468"><i>Stochastic Dynamical Systems Based Latent Structure Discovery in High-dimensional Time Series</i></a>
    </span>
    <div class="pub-authors" itemprop="author">
...
<i class="fa-li fa fa-file-text-o pub-icon" aria-hidden="true"></i>
    <span itemprop="name">
        <a href="https://www.nature.com/articles/srep21468"><i>Avalanche: an End-to-End Library for Continual Learning</i></a>
    </span>
    <div class="pub-publication">
...
<i class="fa-li fa fa-file-text-o pub-icon" aria-hidden="true"></i>
    <span itemprop="name">
        <a href="https://www.nature.com/articles/srep21468"><i>CatNet: Class Incremental 3D ConvNets for Lifelong Egocentric Gesture Recognition</i></a>
    </span>
    <div class="pub-authors" itemprop="author">
...
<i class="fa-li fa fa-file-text-o pub-icon" aria-hidden="true"></i>
    <span itemprop="name">
        <a href="https://www.nature.com/articles/srep21468"><i>A Neuro-AI Interface for Evaluating Generative Adversarial Networks</i></a>
    </span>
    <div class="pub-authors" itemprop="author">
        Zhengwei Wang, <b> Qi She </b>, Alan F. Smeaton, Tomas E. Ward, Graham Healy.
    </div>
